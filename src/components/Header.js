...
const Header = () => {
  ...
  return (
    <header className="h-30 w-full">
      <nav
        key={theme}
        className="bg-pink-100 text-black flex justify-between items-center px-2 h-[90px] dark:bg-gray-950 dark:text-white"
      >
        ...
        <ul className="flex gap-5 items-center">
          ...
          <li className="w-10 hover:scale-105 hover:cursor-pointer transition relative">
            <Link to="/cart">
              ...
              <div className="w-5 h-5 rounded-full bg-red-600 absolute bottom-9 left-6 flex items-center justify-center">
          ...
          <li className="font-semibold cursor-pointer" onClick={toggleTheme} data-testid="toggle-list">
            {theme === "light" ? (
              <MoonIcon  />
            ) : (
              <SunIcon  />
